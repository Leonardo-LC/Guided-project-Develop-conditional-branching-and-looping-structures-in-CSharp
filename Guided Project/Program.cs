                ...
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 2] == "Age: ?")
                    {
                        ...
                        do
                        {
                            ...
                            if (age <= 0)
                            {
                                Console.WriteLine("The age can not be 0");
                                validAge = false;
                            }
                            
                            if (!validAge)
                            {
                                Console.WriteLine("Please, enter an integer number value for the age");
                            }
                    ...
                    if (ourAnimals[i, 4] == "Physical description: ")
                    {
                        ...
                        do
                        {
                            Console.WriteLine($"Type ID's {ourAnimals[i, 0]} physical description: ");
                            readResult = Console.ReadLine();
                            ...
                            {
                                Console.WriteLine("The animal description can not be empty.");
                            }
